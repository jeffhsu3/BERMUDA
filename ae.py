...
class Encoder_2(nn.Module):
    def __init__(self, num_inputs):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(num_inputs, 20), nn.ReLU(), nn.Linear(20, 2)
        )
...
class Decoder_2(nn.Module):
    def __init__(self, num_inputs):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(2, 20), nn.ReLU(), nn.Linear(20, num_inputs), nn.ReLU()
        )
...
class Encoder_20(nn.Module):
    def __init__(self, num_inputs):
        ...
        self.encoder = nn.Sequential(
            nn.Linear(num_inputs, 200), nn.ReLU(), nn.Linear(200, 20)
        )
        self.encoder.apply(init_weights)
...
class Decoder_20(nn.Module):
    def __init__(self, num_inputs):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(20, 200), nn.ReLU(), nn.Linear(200, num_inputs), nn.ReLU()
        )
        self.decoder.apply(init_weights)
